...
export const Home: React.FC = () => {
  const { isLoggedIn, promotions, createBuyerRequest, language } = useAppContext();
    ...
    <div className={`max-w-7xl mx-auto px-4 py-6 ${isRTL ? 'font-sans' : ''}`} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className={`hidden lg:flex w-64 flex-shrink-0 flex-col gap-4 ${isRTL ? 'order-first' : ''}`}>
          {!isLoggedIn && (
            <div className="bg-white p-4 rounded-lg alibaba-shadow flex-grow">
              <h4 className="font-bold text-sm mb-4">{t.welcome_guest}</h4>
              ...
              <div className="mt-8 pt-4 border-t border-gray-100">
                ...
                <button 
                  onClick={() => createBuyerRequest({
                    title: 'Customer quote request',
                    description: 'A visitor requested supplier quotes from the home page.',
                    category: 'All',
                    budget: 0,
                    contactEmail: 'visitor@hawta-maroc.local',
                  })}
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {promotions.slice(0, 12).map((promo, idx) => (
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-xl alibaba-shadow overflow-hidden relative">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div 
              onClick={() => navigate('/deals?category=High-Tech')}
            ...
            <div 
              onClick={() => navigate('/deals?category=Maison')}
      ...
      <section className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            {[...promotions, ...promotions, ...promotions].slice(0, 12).map((p, i) => (
